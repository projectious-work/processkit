...
- [ ] Read `/workspace/aibox.lock` — confirm `[aibox].cli_version = "0.25.8"`
...
Check https://github.com/projectious-work/aibox/issues for known issues with v0.25.8.
