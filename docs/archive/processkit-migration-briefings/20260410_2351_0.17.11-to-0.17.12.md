...
**Status:** completed
**aibox CLI:** v0.17.11 → v0.17.12
**processkit:** vlatest

## Summary

aibox has been updated from v0.17.11 to v0.17.12. Review each section below
...
- [ ] Check `/workspace/context/migrations/pending/` for processkit content migration files:
      ...
      - **When reviewing template files like `AGENTS.md`:** do NOT diff the installed
        ...
        `diff context/templates/processkit/v0.8.0/AGENTS.md context/templates/processkit/vlatest/AGENTS.md`
