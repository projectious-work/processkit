...
processkit is tracking `version = "latest"` — installed: `v0.22.0` (upgraded from `v0.22.0` — aibox.toml now targets `vlatest`) (source: `https://github.com/projectious-work/processkit.git`).
