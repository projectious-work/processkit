...
kind: Artifact
metadata:
  id: ART-20260503_1424-ModelSpec-openai-gpt-5-5-pro
...
spec:
  ...
  provider: openai
  family: gpt-5.5-pro
  legacy_model_id: MODEL-openai-gpt-5-5-pro
  profile_ids:
  - gpt-5.5-pro
  versions:
  - version_id: '1'
    ...
    pricing_usd_per_1m:
      input: 30.0
      output: 180.0
    pricing_note: 'OpenAI announcement: higher-accuracy GPT-5.5 Pro API pricing.'
    lifecycle: active
    source_urls: &id001
  ...
  rationale: Frontier flagship premium (estimated, 2026-04-25)
  lifecycle: active
  source_urls: *id001
  model_classes: []
  task_suitability:
