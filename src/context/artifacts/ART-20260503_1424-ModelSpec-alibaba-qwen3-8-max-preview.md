...
kind: Artifact
metadata:
  id: ART-20260503_1424-ModelSpec-alibaba-qwen3-8-max-preview
...
spec:
  ...
  legacy_model_id: MODEL-alibaba-qwen3-8-max-preview
  profile_ids:
  - qwen3.8-max-preview
  versions:
  - version_id: '1'
    ...
    pricing_note: Official Model Studio catalog confirms availability; regional/token-plan
      pricing varies.
  ...
  rationale: Current Alibaba flagship preview
  lifecycle: unverified
  source_urls: *id001
  model_classes:
  - standard
