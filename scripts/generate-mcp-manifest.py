...
``--check`` verifies that both tracked manifests already match the
generated content and does not write files. Exits 0 on success, 1 on any
error or stale manifest.
"""
