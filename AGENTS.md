...
On session start, run `morning-briefing-generate` before acting. It
...
pinned at `v0.18.0`, package tier(s) `product`, to manage process
...
<sub>Scaffolded by processkit `v0.18.0` on `2026-04-17`. Re-rendered on each installer sync.</sub>
