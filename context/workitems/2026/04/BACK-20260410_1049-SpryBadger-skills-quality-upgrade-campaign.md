...
spec:
  ...
  priority: medium
  description: |
    The March 2026 quality audit (NOTE-20260410_1046-RapidPeak) found ~55% of skills are "thin-tier": no code examples (54% of skills), no allowed-tools declaration (55%). The audit covered 85 skills; processkit now ships 128+, warranting a fresh audit.
