...
spec:
  ...
  priority: high
  description: |
    The Artifact primitive (schema: src/context/schemas/artifact.yaml, prefix ART, default dir: context/artifacts/) has no management skill or MCP server. Confirmed gap from primitive-skills-mapping-2026-03 (NOTE-20260410_1046-BraveSea). 17 reference notes in context/notes/ are awaiting promotion to Artifact entities once this skill exists.
    ...
    Also still missing: constraint-management, taxonomy-management, state-machine-management skills (lower priority).
