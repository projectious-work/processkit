...
spec:
  ...
  priority: medium
  description: |
    The owner-profiling skill references two files that must exist and be complete:
    ...
    Full spec for observable-signals.md is in NOTE-20260410_1046-StoutSwan (sourced from aibox/move-to-processkit/research/owner-profiling-skill-2026-03.md). It defines 24 signals across 4 categories (communication, technical preferences, decision patterns, workflow patterns).
    ...
    Note: multi-actor extension (context/actors/<actor-id>/ four-file structure) is a future item, not in scope here.
