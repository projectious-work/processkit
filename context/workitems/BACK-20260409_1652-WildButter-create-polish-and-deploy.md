...
spec:
  ...
  description: 'High-priority docs push. Covers:
    ...
    - BACK-008: per-primitive pages (workitem, decisionrecord, migration, etc.) —
    auto-generated from schemas

    - BACK-009: update/replace the 13 stale aibox-era skill catalog pages with processkit-accurate
