...
kind: Migration
metadata:
  id: MIG-20260728_1913-ContentSync-processkit-content-sync
  created: 2026-07-28 19:13:57+00:00
  updated: '2026-07-28T19:50:48+00:00'
spec:
  source: processkit
  ...
  summary: 0 changed upstream, 2 conflicts, 15 new, 0 removed, 0 stale-removed (9
    groups affected)
  affected_groups:
  - AGENTS
  - context/artifacts
  ...
  - path: context/skills/product/user-research/SKILL.md
    classification: changed-locally-only
  started_at: '2026-07-28T19:50:47+00:00'
  applied_at: '2026-07-28T19:50:48+00:00'
  progress_notes:
  - timestamp: '2026-07-28T19:50:48+00:00'
    actor: mcp
    note: Accepted the synchronized product-package contraction. The release-semver
      conflict is dispositioned by enabling release-semver in aibox.toml for restoration
      on the next host-side aibox sync.
---

# Migration MIG-20260728_1913-ContentSync-processkit-content-sync

From `v0.27.1` to `v0.28.4` (source: `https://github.com/projectious-work/processkit.git`).

0 changed upstream, 2 conflicts, 15 new, 0 removed, 0 stale-removed (9 groups affected)

## Counts

- unchanged: 557
- changed-locally-only: 148
