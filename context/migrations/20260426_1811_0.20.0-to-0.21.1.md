...
- [ ] Read `/workspace/aibox.lock` — confirm `[aibox].cli_version = "0.21.1"`
...
processkit is tracking `version = "latest"` — installed: `v0.23.0` (upgraded from `v0.23.0` — aibox.toml now targets `vlatest`) (source: `https://github.com/projectious-work/processkit.git`).
...
Check https://github.com/projectious-work/aibox/issues for known issues with v0.21.1.
