...
- [ ] Verify `/workspace/context/templates/processkit/v0.11.1/` snapshot directory exists
...
- [ ] Check `/workspace/context/migrations/pending/` for processkit content migration files:
      ...
      - **When reviewing template files like `AGENTS.md`:** do NOT diff the installed
        ...
        `diff context/templates/processkit/v0.11.1/AGENTS.md context/templates/processkit/v0.11.1/AGENTS.md`
...
processkit is tracking `version = "latest"` — installed: `v0.11.1` (upgraded from `v0.11.1` — aibox.toml now targets `vlatest`) (source: `https://github.com/projectious-work/processkit.git`).
