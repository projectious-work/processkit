...
metadata:
  processkit:
    ...
    id: SKILL-20260406_0000-AgentManagement
    version: "1.1.0"
...
- **Deferred entity creation — saying "I'll track that" without calling the tool.** Any commitment to create a WorkItem, DecisionRecord, or other entity must be executed in the same turn. Deferred commitments are routinely dropped across turn boundaries, leaving the entity layer out of sync with what was agreed.
