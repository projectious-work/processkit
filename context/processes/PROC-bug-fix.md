...
spec:
  ...
  - name: merge
    ...
    - GATE-code-review-passed
  definition_of_done: |
    Bug is reproducible from the failing test before the fix; the test passes after the fix; the change is reviewed, approved, and merged; the original bug report is closed or updated with the resolution.
  retryable: true
---
