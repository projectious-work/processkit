...
kind: Artifact
metadata:
  id: ART-20260503_1424-ModelSpec-moonshot-kimi-k3
...
spec:
  ...
  provider: moonshot
  family: kimi-k3
  legacy_model_id: MODEL-moonshot-kimi-k3
  profile_ids:
  - kimi-k3
  versions:
  - version_id: '1'
    ...
    pricing_note: Official catalog confirms availability; pricing requires account-specific
      confirmation.
  ...
  rationale: Frontier reasoning and coding
  lifecycle: unverified
  source_urls: *id001
  model_classes: []
  task_suitability:
