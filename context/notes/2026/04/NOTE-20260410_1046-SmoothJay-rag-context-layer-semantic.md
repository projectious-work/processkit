...
metadata:
  ...
  created: 2026-04-10
spec:
  body: Research for semantic search over the processkit `./context/` directory. Evaluates
    embedding models, vector storage, MCP integration, existing tools, indexing…
