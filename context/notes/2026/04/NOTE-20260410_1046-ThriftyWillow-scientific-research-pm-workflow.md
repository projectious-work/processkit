...
metadata:
  ...
  created: 2026-04-10
spec:
  body: 'Purpose: Analyze what a scientific research process template needs, map to
    existing primitives, identify gaps'
  title: Scientific research PM — full workflow, primitive mapping, and identified
    primitive gaps
  type: reference
  state: captured
  tags:
