...
metadata:
  ...
  created: 2026-04-10
spec:
  body: processkit needs a storage layer for process primitives -- work items, events,
    decisions, projects, metrics, cross-references, and user-defined entities. This…
