...
spec:
  ...
  details:
    ...
    open_threads:
    - BACK-20260410_1049-HappyHare — Build artifact-management skill and MCP server
      [high]. No artifact primitive skill exists; Notes currently bridge the gap.
    - BACK-20260410_1049-KeenCrane — Add docs content from aibox to WildButter docs-site
      [high, child of WildButter epic]. The 5 content blocks are captured in NOTE-20260410_1136-PluckyIvy.
    - BACK-20260410_1050-DeepFrog — Add cloud provider skills — AWS, GCP, Azure [high].
      Critical ecosystem gap identified in skills audit.
    - BACK-20260410_1049-SpryBadger — Skills quality upgrade campaign [medium]. Identified
      in skills-quality-audit Note.
    ...
    - BACK-20260410_1049-BraveMeadow — Verify and complete owner-profiling reference
      files [medium].
    - All new context files are uncommitted. A commit should be made before the next
      session to avoid git state confusion.
    ...
    - 'Proactive skill-finder use: in the previous context window the agent skipped
      the skill-finder before placing research artifacts, leading to the user correcting
      the approach twice. Feedback memory was saved to /home/aibox/.claude/projects/-workspace/memory/feedback_use_skill_catalog_first.md.
      The session-handover skill was correctly located via skill-finder this time
      — rule is being applied.'
    - 'Content preservation: initial migration produced thin summaries rather than
      full content. All 17 research Notes, the main discussion entity, and 2 appendix
      Notes were subsequently rewritten with full original content. Rule encoded in
      the feedback memory above.'
---
