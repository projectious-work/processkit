...
A curated selection of the most commonly used skills per category.
For the full 120+ skill catalog, read `src/skills/INDEX.md`.
...
If no skill in this index matches, check `src/skills/INDEX.md` for the full
...
- **Treating the trigger-phrase table as exhaustive.** The table maps common
  ...
  matches, scan the by-category section or read `src/skills/INDEX.md`. If
