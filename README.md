...
```sh
curl -L \
  https://github.com/projectious-work/processkit/releases/download/v0.25.7/processkit-v0.25.7.tar.gz \
  -o processkit-v0.25.7.tar.gz
tar -xzf processkit-v0.25.7.tar.gz

cp -a processkit-v0.25.7/context ./context
cp -a processkit-v0.25.7/.processkit ./.processkit
cp processkit-v0.25.7/AGENTS.md ./AGENTS.md
```
...
`v0.25.7` is the current patch release. It keeps the v0.25.0 gateway
and v2 deliverable boundary, adds command-aware routing, sqlite-vec
diagnostics, runtime-capacity planning, and fast Codex Spark routing.
